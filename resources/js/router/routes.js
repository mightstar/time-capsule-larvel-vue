...
import { default as PageMessages } from "@/views/pages/private/messages/Index";
import { default as PageMessagessCreate } from "@/views/pages/private/messages/Create";
import { default as PageMessagesEdit } from "@/views/pages/private/messages/Edit";
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        path: "create",
                        meta: { requiresAuth: true },
                        component: PageMessagessCreate,
                    },
                    {
                        name: "messages.edit",
                        path: ":id/edit",
                        meta: { requiresAuth: true },
                        component: PageMessagesEdit,
                    },
                ],
            },
        ],
